...
**Shipped (latest, v3.9 · Jun 29, 2026):** Open the Cursor mobile app, choose a repo, and launch an agent the same way you would on the desktop app. Pick any frontier model, describe ideas out loud with voice input, and use slash commands to guide Cursor in the right direction.
...
- [Invest and Sell Anysphere (Cursor AI) Stock - Forge Global](https://forgeglobal.com/anysphere_stock/) — _forgeglobal.com_
